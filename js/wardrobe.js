...
const PLANETARY_DAYS = [
  { day: 0, name: "Sunday", planet: "Sun", glyph: "☉", colour_name: "Gold & Amber", hex: "#DAA520", narrative: "The Sun demands visibility. Today's energy supports taking up space and being perceived. Dress in a way that feels like the center of gravity.", textures: "Silk, Organza, Structured gold", avoid: "Muted tones, hiding in layers", accessory: "Statement gold pieces, amber rings" },
  { day: 1, name: "Monday", planet: "Moon", glyph: "☽", colour_name: "Silver & White", hex: "#E0E6ED", narrative: "The Moon asks for receptivity and flow. Let your silhouette soften. Today is about intuitive dressing rather than armor.", textures: "Linen, Flowing cotton, Soft knits", avoid: "Rigid structure, heavy synthetics", accessory: "Pearls, silver chains, moonstone" },
  { day: 2, name: "Tuesday", planet: "Mars", glyph: "♂", colour_name: "Crimson & Rust", hex: "#8B0000", narrative: "Mars provides kinetic energy. The atmosphere requires momentum and edge. Your clothing should feel like an active choice, not a default.", textures: "Leather, Denim, Sharp tailoring", avoid: "Overly delicate fabrics, indecisive fits", accessory: "Iron, sharp angles, bold boots" },
  { day: 3, name: "Wednesday", planet: "Mercury", glyph: "☿", colour_name: "Emerald & Mixed Patterns", hex: "#2E8B57", narrative: "Mercury is mutable and communicative. Today favors flexibility, layering, and pieces that can transition easily as the day shifts.", textures: "Breathable cotton, Plaid, Mixed textiles", avoid: "Monolithic heavy outfits", accessory: "Layered necklaces, practical bags, agate" },
  { day: 4, name: "Thursday", planet: "Jupiter", glyph: "♃", colour_name: "Royal Blue & Indigo", hex: "#4169E1", narrative: "Jupiter expands whatever it touches. There is an atmosphere of abundance. Lean into rich colors and generous, comfortable silhouettes.", textures: "Velvet, Rich wool, Drapey fabrics", avoid: "Constricting garments, scarcity mindset in styling", accessory: "Amethyst, large pendants, lapis lazuli" },
  { day: 5, name: "Friday", planet: "Venus", glyph: "♀", colour_name: "Rose & Soft Pastels", hex: "#D8BFD8", narrative: "Venus harmonizes. The focus is on aesthetic pleasure and tactile comfort. Let your clothing feel good against the skin.", textures: "Silk, Lace, Cashmere", avoid: "Harsh lines, abrasive materials", accessory: "Copper, rose quartz, elegant symmetry" },
  { day: 6, name: "Saturday", planet: "Saturn", glyph: "♄", colour_name: "Onyx & Charcoal", hex: "#2F4F4F", narrative: "Saturn deals in boundaries and endurance. The energy is serious and grounded. Choose pieces that feel protective, classic, and structurally sound.", textures: "Heavy wool, Stiff denim, Gabardine", avoid: "Frivolous trends, flimsy layers", accessory: "Antique silver, obsidian, heirlooms" }
];
