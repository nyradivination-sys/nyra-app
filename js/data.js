const STELLAR = {
  ...
  tarot: [
    ...
    { card_number: "V", card_name: "The Hierophant", keywords: ["TRADITION", "BELIEF", "SYSTEM"], element: "EARTH", ruling_planet: "♀\uFE0E Venus" },
    { card_number: "VI", card_name: "The Lovers", keywords: ["CHOICE", "MIRROR", "DESIRE"], element: "AIR", ruling_planet: "☿\uFE0E Mercury" },
    { card_number: "VII", card_name: "The Chariot", keywords: ["WILLPOWER", "DIRECTION", "VICTORY"], element: "WATER", ruling_planet: "☽\uFE0E Moon" },
    { card_number: "VIII", card_name: "Strength", keywords: ["COURAGE", "PATIENCE", "HEART"], element: "FIRE", ruling_planet: "☉\uFE0E Sun" },
    { card_number: "IX", card_name: "The Hermit", keywords: ["SOLITUDE", "INTROSPECTION", "GUIDANCE"], element: "EARTH", ruling_planet: "☿\uFE0E Mercury" },
    { card_number: "X", card_name: "Wheel of Fortune", keywords: ["CYCLE", "TURNING", "FATE"], element: "FIRE", ruling_planet: "♃\uFE0E Jupiter" },
    { card_number: "XI", card_name: "Justice", keywords: ["TRUTH", "BALANCE", "LAW"], element: "AIR", ruling_planet: "♀\uFE0E Venus" },
    { card_number: "XII", card_name: "The Hanged Man", keywords: ["SURRENDER", "PERSPECTIVE", "WAITING"], element: "WATER", ruling_planet: "♆\uFE0E Neptune" },
    { card_number: "XIII", card_name: "Death", keywords: ["ENDING", "RELEASE", "TRUTH"], element: "WATER", ruling_planet: "♇\uFE0E Pluto" },
    { card_number: "XIV", card_name: "Temperance", keywords: ["ALCHEMY", "MODERATION", "SYNTHESIS"], element: "FIRE", ruling_planet: "♃\uFE0E Jupiter" },
    { card_number: "XV", card_name: "The Devil", keywords: ["BONDAGE", "MATERIALISM", "SHADOW"], element: "EARTH", ruling_planet: "♄\uFE0E Saturn" },
    { card_number: "XVI", card_name: "The Tower", keywords: ["DISRUPTION", "AWAKENING", "COLLAPSE"], element: "FIRE", ruling_planet: "♂\uFE0E Mars" },
    { card_number: "XVII", card_name: "The Star", keywords: ["HOPE", "HEALING", "RENEWAL"], element: "AIR", ruling_planet: "♅\uFE0E Uranus" },
    ...
    { card_number: "XX", card_name: "Judgement", keywords: ["RECKONING", "CALLING", "REBIRTH"], element: "FIRE", ruling_planet: "♇\uFE0E Pluto" },
    { card_number: "XXI", card_name: "The World", keywords: ["COMPLETION", "INTEGRATION", "WHOLENESS"], element: "EARTH", ruling_planet: "♄\uFE0E Saturn" }
  ],
  wardrobe: {
